...
# Train a Decision Tree on the PCA-transformed data
dt = DecisionTreeClassifier(random_state=42, max_depth=2)  # Set max_depth=2 for simplicity
...
plot_tree(dt, feature_names=["Principal Component 1", "Principal Component 2"], 
